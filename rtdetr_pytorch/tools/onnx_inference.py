...
if __name__ == "__main__":
    onnx_model_path = "./rtdetr_pytorch/weights/rtdetr_r18vd_5x_coco_objects365_from_paddle_opt.onnx"
    ...
    image = Image.open('./download/ssd_horse.jpg').convert('RGB')
    ...
    image.save("./download/output_onnx.jpg")
