...
if __name__ == "__main__":
    axmodel_model_path = "/data/baizanzhou/project/customer/RT-DETR/ori_repo/RT-DETR/rtdetr_pytorch/weights/rtdetr_r18vd_5x_coco_objects365_from_paddle_ori.onnx"
    ...
    image = Image.open('/data/baizanzhou/project/customer/RT-DETR/download/ssd_horse.jpg').convert('RGB')
    ...
    image.save("/data/baizanzhou/project/customer/RT-DETR/download/output.jpg")
